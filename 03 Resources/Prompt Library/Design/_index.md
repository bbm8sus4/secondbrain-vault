---
title: Prompt Library — Design (by context)
type: index
context: design
status: live
tags: [prompt, index, design]
---
...
2. ใส่ frontmatter: `type: prompt`, `context: design`, `use:`, `created:`
3. วาง prompt ไว้ในกล่อง ``` code fence ``` ให้ copy ง่าย
4. เพิ่มลิงก์ที่ลิสต์ด้านบน
