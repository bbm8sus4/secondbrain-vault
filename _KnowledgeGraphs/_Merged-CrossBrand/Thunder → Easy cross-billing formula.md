...
## Connections
- [[Cost Scenario B (mix blend ~3070, cost 0.077, GP 38.4%)]] - `semantically_similar_to` [INFERRED]
- [[EasySlip (บริษัท อีซี่สลิป จำกัด — SMB brand)]] - `conceptually_related_to` [EXTRACTED]
- [[KBank Slip Verification API pricing (tiered, excl. VAT)]] - `shares_data_with` [EXTRACTED]
