...
# Thunder KBank Pricing

**Cohesion:** 0.12 - loosely connected
**Members:** 20 nodes

## Members
- [[Bill Payment (PromptPay QR)]] - concept - Reports/thunder_solution_info.html
- [[Coperate A-J Tiers]] - concept - Reports/thunder-corporate-api-sales-commission.md
...
- [[Developer API]] - concept - Reports/thunder_solution_info.html
...
- [[Letter & Document Editor]] - concept - Reports/thunder_solution_info.html
...
- [[Thunder API]] - concept - Reports/thunder-may-2026-summary.html
- [[Thunder BNI 5-Minute Presentation]] - document - Reports/bni-thunder-5min.html
- [[Thunder Bot]] - concept - Reports/thunder-may-2026-summary.html
- [[Thunder Corporate API (MOU)]] - document - Reports/thunder-corporate-api-sales-commission.md
- [[Thunder Solution]] - concept - Reports/bni-thunder-5min.html
- [[Thunder Solution Platform]] - document - Reports/thunder_solution_info.html

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Thunder_KBank_Pricing
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Thunder–EasySlip Integrations]]

## Top bridge nodes
- [[Thunder BNI 5-Minute Presentation]] - degree 2, connects to 1 community